...
public class Payment_Details extends JFrame{ //Fifth
	...
	Sector.setFont(new Font("poppins", Font.BOLD, 32));
	...
	Classcode = new JLabel("PAYMENT DATE");
	...
	label = new JLabel("");
	label.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/payment1.png")));
	label.setBounds(425, 15, 300, 300);
	add(label);
	...
	Phoneno.setBounds(712, 294, 100, 24);
	add(Phoneno);
