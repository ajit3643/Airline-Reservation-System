...
public class Add_Customer extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_Customer(){
            ...
            Female.setBounds(280, 320, 100, 27);
            add(Female);
            ...
            AddPassengers.setFont(new Font("poppins", Font.BOLD, 32));
            AddPassengers.setBounds(520, 20, 442, 35);
            add(AddPassengers);
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/person1.png"));
            JLabel image = new JLabel(i1);
            image.setBounds(450,80,500,440);
            add(image);
