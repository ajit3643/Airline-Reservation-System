...
public class Journey_Details extends JFrame{  //Forth
	...
	ReservationDetails.setFont(new Font("POPPINS", Font.BOLD, 32));
	ReservationDetails.setBounds(280, 25, 359, 50);
	...
	String[] items1 =  {"PTNA", "MUMBAI", "CHENNAI", "BANGALORE","DELHI","HYDERABAD"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"DELHI", "MUMBAI", "CHENNAI", "PATNA","BANGALORE","HYDERABAD"};
